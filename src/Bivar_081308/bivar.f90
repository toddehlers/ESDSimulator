subroutine interpolate(num_input, num_output, xi, yi, zi, xo, yo, zo)
  implicit none

  ! function parameter
  integer(4), intent(in) :: num_input, num_output
  real(8), dimension(num_input), intent(in) :: xi, yi, zi
  real(8), dimension(num_output), intent(in) :: xo, yo
  real(8), dimension(num_output), intent(out)  :: zo
  ...
  do i=1,num_output
     ...
     zo(i) = 0.0
     do k=1,4
        zo(i) = zo(i) + zi(current_index(k))
     enddo
     zo(i) = zo(i) / 4.0

  enddo ! i=1,num_output
...
!
!    Input, integer NCP, the number of additional data points used for 
...
!     print *, "bivar.f90: call to idtang"
...
!     print *, "bivar.f90: call to idcldp"
...
!    print *, "bivar.f90: call to idlctn"
...
!  print *, "bicar.f90: call to idpdrv"
...
!  print *, "bivar.f90: call to idptip"
...
!    estimating partial derivatives at each data point.
!
!    Output, integer IPC(NCP*NDP), the indices of NCP data points closest
...
!
!    Input/output, integer IWK(18*NDP), real ( kind = 8 ) WK(8*NDP),
...
!    estimating partial derivatives at each data point,
!
!    Input, integer IPC(NCP*NDP), the indices of NCP data points closest to
...
!  print *, "bivar.f90, idptip"
!  print *, "file: " // __FILE__
!  print *, "line: ", __LINE__
!  print *, "date: " // __DATE__
!  print *, "time: " // __TIME__

!  print *, "number of triangles, nt: ", nt
!  print *, "number of border line segments, nl: ", nl
!  print *, "triangle number, iti: ", iti
...
!
      ...
      if (dlt == 0.0) then
         print *, "dlt: ", dlt, ", a: ", a, ", b: ", b, ", c: ", c, ", d: ", d, ", x0: ", x0, ", y0: ", y0
         print *, "x: ", x
         print *, "y: ", y
         print *, "z: ", z
      endif
...
!
!    Input, integer NCP, the number of data points used to estimate partial
...
!
!    Input, integer I1, I2, I3, I4, indices of four points P1, P2,
!    P3, and P4 that form a quadrilateral with P3 and P4 connected diagonally.
!
!    Output, integer IDXCHG, is 1 if an exchange is recommended, and 0 otherwise.
!
  implicit none
