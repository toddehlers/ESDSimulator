...
c
      ...
      real*4   temp_i(n),time_i(n),time_temp(n)
...
c note: modified to use correct beta value for fluorapatite from
c Crowley et al., 1991 - dwhipp 02/07
...
c lc,mod fanning Arrhenius model from Ketcham et al., 1999 table 5e
c *** DO NOT USE: Not yet functional ***
c added by dwhipp (08/07)

      a=-0.05771
      b=-13.218
      c0=-9.0722
      c1=0.00029896
c Original c2 of Ketcham et al., 1999 modified for version of track length reduction
c equation used below
      c2=-15.846
      c3=0.00076370
...
c equation for decrease in normalized track length from Ketcham et al., 1999
c note: this is slightly different than above, and may require other code mods to implement
c also note: this is currently not functional
c dwhipp - (08/07)
c        gr=c0+c1*((alog(dt)+c2)/((1./tempm)-c3))
        r(i)=xinv(gr,a,b)
