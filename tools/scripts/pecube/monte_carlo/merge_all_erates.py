...
with open("exported_erate_gfit_all.txt", "w") as output_file:
    output_file.write("# number_of_good_fits(j), k, j, mc_random_erosion_rate(k)\n")
        ...
        with open(file_name, "r") as input_file:
            ...
            for line in input_file.readlines():
                ...
                if len(line_splitted) == 4:
                    ...
                    erosion_rate = float(line_splitted[3])
                    ...
                    if (index_k, index_j) in global_erate_counter:
                        output_file.write("{0:d} {1:d} {2:d} {3:f}\n".format(num_of_good_fits +
                            global_erate_counter[(index_k, index_j)], index_k, index_j, erosion_rate))
                    else:
                        output_file.write("{0:d} {1:d} {2:d} {3:f}\n".format(num_of_good_fits,
                            index_k, index_j, erosion_rate))
